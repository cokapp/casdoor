...
func TestCdn(t *testing.T) {
	provider := &object.Provider{
		...
		Bucket:       getEnvOrDefault("PROVIDER_BUCKET", "cokuser"),
		Endpoint:     getEnvOrDefault("PROVIDER_ENDPOINT", "https://s3.cn-south-1.qiniucs.com"),
		Domain:       getEnvOrDefault("PROVIDER_DOMAIN", ""),
